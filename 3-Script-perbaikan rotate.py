        ...
        for k in range(N_STORY):
            ...
            for i in range(BAY_X_COUNT + 1):
                for j in range(BAY_Y_COUNT + 1):
                    ...
                    # UPDATE: Adding +90 offset to align "0 input" with SAP2000's default (Web along X)
                    eff_rotation_deg = COLUMN_ROTATION_DEG + 90.0
                    col_rotation_rad = math.radians(eff_rotation_deg)
